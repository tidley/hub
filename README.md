...
For the default backend which runs a node internally we recommend 1+GB of disk space and 2GB of RAM (or 512MB Ram + 2GB swap can also be used). For connecting to an external node, Alby Hub uses very little RAM (256mb is enough).
